...
cross_road = input(f''' You're at a cross road. Where do you want to go? Type "left" or "Right" ''')

if cross_road.lower() != "left":
    print("Fall into a hole. \n Game Over.")
elif cross_road.lower() == "left":
    swim_or_wait = input(f''' You've come to a lake. There is an island in the middle of the lake. \n Type "wait" to wait for a boat. Type "swim" to swim across. ''')
